    ...
    return (
        <div className='md:flex justify-between gap-[50px] items-center my-6 md:my-12'>
            <div className="md:w-1/2">
                <h1 className='text-2xl leading-10 md:text-4xl md:leading-[52px] font-light'>Enhance
                    your <b>Shopify</b> store
                    with our professional front-end development services ✦ Secure an
                    impressive
                    and functional design that attracts and retains your customers
                </h1>
                <div className='flex items-center gap-2 flex-wrap my-4 md:my-6'>
